      ...
      <Table className="w-full text-left border-collapse">
        <TableHeader className="bg-gray-50 text-gray-500">
          <TableRow>
            ...
            <TableHead className="px-6 py-4 text-[12px] font-bold uppercase tracking-wider text-center">Phổ Kháng Khuẩn</TableHead>
            <TableHead className="px-6 py-4 text-[12px] font-bold uppercase tracking-wider text-center">Mức độ tiếp cận</TableHead>
